...
%% theta
% theta  = -314:628;
theta  = -180*mult_theta:1:360*mult_theta;
stheta = round(sin(theta/mult_theta*pi/180)*mult_sincos);
ctheta = round(cos(theta/mult_theta*pi/180)*mult_sincos);
...
%% FILE GENERATION
file_ID = fopen(strcat('trig_',num2str(mult_theta),'_',num2str(mult_sincos),'_deg.v'),'w');
